...
- **CodeBurn costs** (optional): a project-root-scoped cost strip plus a native usage dashboard (`U`) for daily activity, projects, models, activities, providers, tools, MCP servers, skills, agents, and workflow metrics. See [CodeBurn usage](docs/codeburn.md).
...
| `U` | CodeBurn cost and usage dashboard (when CodeBurn is installed) |
